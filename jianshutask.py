...
def job():
    ...
    if jianshusummary.processJianshuSummary():
        ...
        subprocess.call(['zsh', '/Users/wangyang/Documents/Codes/OnGit/SquarePants1991.github.io/publish.sh'])
# BlockingScheduler
scheduler = BlockingScheduler()
scheduler.add_job(job, 'cron', day_of_week='1-7', hour=17, minute=20)
scheduler.start()
